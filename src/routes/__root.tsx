  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass rounded-3xl p-10">
        ...
        <div className="mt-6">
          <Link to="/" className="btn-primary inline-flex rounded-full px-6 py-2.5 text-sm font-medium">
            Go home
          </Link>
        </div>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass rounded-3xl p-10">
        ...
        <div className="mt-6 flex justify-center gap-2">
          <button onClick={() => { router.invalidate(); reset(); }} className="btn-primary rounded-full px-6 py-2.5 text-sm font-medium">
            Try again
          </button>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Ayeesha Khatoon — MBA & Business Analyst Portfolio" },
      { property: "og:description", content: "Transforming data into insights and ideas into business value." },
